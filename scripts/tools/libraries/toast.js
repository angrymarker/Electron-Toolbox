...
(function() {
    ...
    Toast.prototype = {
        ...
        getcontent: function() {
        	return $('.toast-content').html();
        },
        append: function(content) {
        	
        	try
        	{
        		$('.toast-content').append('<br>' + content);
        		//$('.toast-content').animate({ scrollTop: $('.toast-content').offset().top }, 1000);
        		$('.toast-content').scrollTop($('.toast-content')[0].scrollHeight);
        	}
        	catch (err)
        	{
        		console.log(err);
